...
const PET_DATA = [
  // --- หมวดหมู่นก (BIRDS) ---
  {
    ...
    linePresetMsg: "สวัสดีครับ/ค่ะ สนใจสอบถามข้อมูลนกซันคอนัวร์ (รหัส BIRD-001) ครับ"
  },
  {
    id: "BIRD-002",
    ...
    linePresetMsg: "สวัสดีครับ/ค่ะ สนใจสอบถามข้อมูลนกค็อกคาเทล แก้มส้ม (รหัส BIRD-002) ครับ"
  },
  {
    id: "BIRD-003",
    ...
    linePresetMsg: "สวัสดีครับ/ค่ะ ต้องการสอบถามและนัดดูตัวนกสการ์เล็ต มาคอว์ (รหัส BIRD-003) ครับ"
  },
  {
    id: "BIRD-004",
    ...
    linePresetMsg: "สวัสดีครับ/ค่ะ สนใจสอบถามนกเลิฟเบิร์ดขอบตา (รหัส BIRD-004) ครับ"
  },
  {
    id: "BIRD-005",
    ...
    linePresetMsg: "สวัสดีครับ/ค่ะ สนใจสอบถามเกี่ยวกับนกแอฟริกันเกรย์ (รหัส BIRD-005) ครับ"
  },
  ...
  // --- หมวดแมว (CATS) ---
  {
    ...
    linePresetMsg: "สวัสดีครับ/ค่ะ สนใจสอบถามน้องแมวเปอร์เซีย (รหัส CAT-001) ครับ"
  },
  {
    id: "CAT-002",
    ...
    linePresetMsg: "สวัสดีครับ/ค่ะ สนใจสอบถามแมวสก็อตติช โฟลด์ (รหัส CAT-002) ครับ"
  },
  ...
  // --- หมวดสุนัข (DOGS) ---
  {
    ...
    linePresetMsg: "สวัสดีครับ/ค่ะ สนใจสอบถามลูกสุนัขโกลเด้น รีทรีฟเวอร์ (รหัส DOG-001) ครับ"
  },
  {
    id: "DOG-002",
    ...
    linePresetMsg: "สวัสดีครับ/ค่ะ สนใจสอบถามลูกสุนัขปอมเมอเรเนียน (รหัส DOG-002) ครับ"
  },
  ...
  // --- หมวดอุปกรณ์และอาหาร (SUPPLIES) ---
  {
    ...
    linePresetMsg: "สวัสดีครับ/ค่ะ สนใจสอบถามกรงนกแก้วสแตนเลส (รหัส SUP-001) ครับ"
  },
  {
    id: "SUP-002",
    ...
    linePresetMsg: "สวัสดีครับ/ค่ะ สั่งซื้ออาหารนก Nutri-Bird A21 (รหัส SUP-002) ครับ"
  },
  {
    id: "SUP-003",
    ...
    linePresetMsg: "สวัสดีครับ/ค่ะ สนใจคอนไม้ธรรมชาติ (รหัส SUP-003) ครับ"
  }
];
...
const REVIEWS_DATA = [
  {
    ...
    rating: 5,
    comment: "รับน้องซันคอนัวร์จากร้านนี้ น้องเชื่องมากและแข็งแรงดีสุดๆ ทางร้านให้คำแนะนำการเลี้ยงอย่างใกล้ชิดผ่าน Line ประทับใจมากครับ!",
  ...
  },
  {
    ...
    rating: 5,
    comment: "นกน่ารักตรงปก บริการส่งด่วนถึงบ้านปลอดภัยดีมาก แอดมินตอบ LINE ไวมาก คอยติดตามอาการลูกนกตลอด แนะนำเลยค่ะร้านนี้",
